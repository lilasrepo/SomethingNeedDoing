...
public unsafe class OceanFishingWrapper : IWrapper
{
    ...
    [LuaDocs] public byte TimeOfDay => Svc.Data.GetExcelSheet<IKDRoute>()?.GetRow(CurrentRoute).Time[CurrentZone].Value.Unknown0 ?? 0; // porting-note(api13): IKDTimeDefine's only column is unnamed in api13 Lumina
